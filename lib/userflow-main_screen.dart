...
import 'userflow-dashboard_screen.dart';
...
class MainScreenEmployee extends StatefulWidget {
  ...
  @override
  State<MainScreenEmployee> createState() => _MainScreenEmployeeState();
}

class _MainScreenEmployeeState extends State<MainScreenEmployee> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: const [
          DashboardScreenEmployee(),
          ScanScreen(),
          RecordsScreen(isUserRole: true),
          SettingsScreen(),
        ],
      ),
